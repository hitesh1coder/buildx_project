      ...
      <table className=" w-[80%] text-center">
        <thead>
          <tr className="bg-[#215895] text-white font-semibold">
            <th className="border-l-2 p-1 lg:p-3 border-[#D9D9D9]">Code</th>
            <th className="border-l-2 p-1 lg:p-3 border-[#D9D9D9]">Name</th>
            <th className="border-l-2 p-1 lg:p-3 border-[#D9D9D9]">
              Designation
            </th>
            <th className="border-l-2 p-1 lg:p-3 border-[#D9D9D9]">
              Contact Details
            </th>
            <th className="border-l-2 lg:p-3 border-[#D9D9D9]">Work Profile</th>
          </tr>
        </thead>
        <tbody>
